...
def batch_dream3d(runner_path, d3d_input_file, directory, shape, size, num_runs, is_periodic=True):
    """
    ...
    pipeline_f = os.path.basename(d3d_input_file)
...
def gen_microstructures(directory, size, shape, face_bc, num_vox, band_thickness, num_planes, create_sub_bands, num_instantiations, generate_new_microstructure_files, compute_kosher_grain_centroids, d3d_input_file, d3d_executable_path):  #d3d_pipeline_path
    # Main function
    ...
    if generate_new_microstructure_files:
        batch_dream3d(d3d_executable_path, d3d_input_file, directory, shape, size, num_instantiations, is_periodic)
...
def main():
    ...
    directory = r'E:\Programming\NF_growth\Dream3d_subprocess\output_files'
    ...
    # d3d_input_file = r'E:\Programming\NF_growth\Dream3d_subprocess\pipelines_and_inputs\Dream3d_input_file.dream3d'
    d3d_input_file = r"E:\Programming\NF_growth\Dream3d_subprocess\output_files\d3d_pipeline.json"
    ...
    # Once again, this may be specified using an absolute path as:
    d3d_pipeline_path = r'E:\Programming\NF_growth\Dream3d_subprocess\pipelines_and_inputs\d3d_pipeline.json'
    
    # Location of DREAM.3D 'PipelineRunner.exe' file; this should be in the DREAM.3D program folder
    d3d_executable_path = r'E:\Programming\DREAM3D-6.5.171-Win64\PipelineRunner.exe'
    ...
    compute_kosher_grain_centroids = False
    ...
    gen_microstructures(directory, size, shape, face_bc, num_vox, band_thickness, num_planes, create_sub_bands, num_instantiations, generate_new_microstructure_files, compute_kosher_grain_centroids, d3d_input_file, d3d_executable_path)#d3d_pipeline_path
